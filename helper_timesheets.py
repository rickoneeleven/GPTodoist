...
def timesheet():
    # Store user inputs to preserve them in case of errors
    user_inputs = {}
    ...
    try:
        ...
        try:
            ...
            print("[yellow]No completed tasks file found. Creating new file.[/yellow]")
            completed_tasks = []
        except json.JSONDecodeError:
            print("[yellow]Error reading completed tasks file. Creating new file.[/yellow]")
            completed_tasks = []
        ...
        # Get user input for task IDs with validation
        while True:
            try:
        ...
        # Get random range from user with validation
        while True:
            try:
