...
def print_commands():
    commands = {
        ...
        "done": "queries the todoist api direct to complete the active task in active_task.json",
        "undo": "queries the todoist api to REOPEN the active task in active_task.json",
        ...
        "add long": "add long [task name] to add task to long_term_tasks.json",
        "complete": "complete [task name] manually add to todays_completed_tasks.json",
